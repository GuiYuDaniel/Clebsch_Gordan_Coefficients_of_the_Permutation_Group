...
class TestCGCInfo(object):
    ...
    def setup(self):
        ...
        self.fake_finish_s_n = 1000
        self.fake_file_name = os.path.join("S{}", "{}_{}", "{}_m{}").format(self.fake_finish_s_n, [1], [1], [1], 1)
        self.fake_table = {
            "file_name": self.fake_file_name,
            "data": {(1, 1,): 1},
            "flags": {"speed_time": 0}
        ...
        self.fake_table_copy = copy.deepcopy(self.fake_table)
        self.fake_partial_table = {"data": {(1, 1,): -1},
                                   "flags": {"speed_time": 2}}
        self.fake_partial_table_copy = copy.deepcopy(self.fake_partial_table)
...
class TestEInfo(object):
    ...
    def setup(self):
        ...
        self.fake_finish_s_n = 1000
        self.fake_file_name = os.path.join("S{}", "{}_{}", "{}_{}").format(self.fake_finish_s_n,
                                                                           [1], [1], [1], 2)
        self.fake_table = {
            "file_name": self.fake_file_name,
            "data": {"ϵ1": 1, "ϵ4": 1, "ϵ5": 1, "ϵ6": 1},
            "flags": {}
        }
        self.fake_table_copy = copy.deepcopy(self.fake_table)
        self.fake_partial_table = {"data": {"ϵ1": 1, "ϵ4": -1, "ϵ5": -1, "ϵ6": -1},
                                   "flags": {}}
        self.fake_partial_table_copy = copy.deepcopy(self.fake_partial_table)
    ...
    def test_ϵ_info(self):
        db_info = EInfo(self.fake_finish_s_n)
        # insert
        flag, msg = db_info.insert(self.fake_table)
        assert flag
        assert msg is True
    ...
    def test_ϵ_finish_s_n_info(self):
        db_info = EInfo(self.fake_finish_s_n)
        # insert
        flag, msg = db_info.insert(self.fake_finish_s_n_table)
        assert flag
    ...
    def test_ϵ_finish_s_n_info_txt(self):
        db_info = EInfo(0)
        # insert
        flag, msg = db_info.insert_txt(self.fake_finish_s_n_table, point_key="flags")
        assert flag
