...
class TestOne(object):
    ...
    def test_make_matrix(self):
        ...
        timer, _ = run_func_n_times(np.array, self.data_100_100_list)
        ...
        timer, _ = run_func_n_times(np.array, self.data_500_500_list)
        ...
        timer, _ = run_func_n_times(sympy.Matrix, self.data_100_100_list)
        ...
        timer, _ = run_func_n_times(sympy.Matrix, self.data_500_500_list)
...
class TestTwo(object):
    ...
    def test_make_data(self):
        ...
        timer, _ = run_func_n_times(Fraction, 1, 10, n=100000)
        ...
        timer, fraction_list_100 = run_func_n_times(self._make_method_list, Fraction, 100)
        ...
        timer, fraction_list_500 = run_func_n_times(self._make_method_list, Fraction, 500, n=10)
        ...
        timer, _ = run_func_n_times(np.array, fraction_list_100)
        ...
        timer, _ = run_func_n_times(np.array, fraction_list_500, n=10)
        ...
        timer, _ = run_func_n_times(Rational, 1, 10, n=100000)
        ...
        timer, rational_list_100 = run_func_n_times(self._make_method_list, Rational, 100)
        ...
        timer, rational_list_500 = run_func_n_times(self._make_method_list, Rational, 500, n=10)
        ...
        timer, _ = run_func_n_times(np.array, rational_list_100)
        ...
        timer, _ = run_func_n_times(np.array, rational_list_500, n=10)
    ...
    def test_matrix_four_fundamental(self):
        ...
        timer, _ = run_func_n_times(np.add, float_array_100, float_array_100, n=20)
        ...
        timer, _ = run_func_n_times(np.add, float_array_200, float_array_200, n=2)
        ...
        timer, _ = run_func_n_times(np.dot, float_array_100, float_array_100, n=10)
        ...
        timer, _ = run_func_n_times(np.dot, float_array_200, float_array_200, n=10)
        ...
        timer, _ = run_func_n_times(np.add, fraction_array_100, fraction_array_100, n=20)
        ...
        timer, _ = run_func_n_times(np.add, fraction_array_200, fraction_array_200, n=2)
        ...
        timer, _ = run_func_n_times(np.dot, fraction_array_100, fraction_array_100, n=1)
        ...
        timer, _ = run_func_n_times(np.dot, fraction_array_200, fraction_array_200, n=1)
        ...
        timer, _ = run_func_n_times(np.add, rational_array_100, rational_array_100, n=20)
        ...
        timer, _ = run_func_n_times(np.add, rational_array_200, rational_array_200, n=2)
        ...
        timer, _ = run_func_n_times(np.dot, rational_array_100, rational_array_100, n=1)
        ...
        timer, _ = run_func_n_times(np.dot, rational_array_200, rational_array_200, n=1)
        ...
        timer, _ = run_func_n_times(_matrix_add, rational_matrix_100, rational_matrix_100, n=20)
        ...
        timer, _ = run_func_n_times(_matrix_add, rational_matrix_200, rational_matrix_200, n=2)
        ...
        timer, _ = run_func_n_times(_matrix_dot, rational_matrix_100, rational_matrix_100, n=1)
        ...
        timer, _ = run_func_n_times(_matrix_dot, rational_matrix_200, rational_matrix_200, n=1)
