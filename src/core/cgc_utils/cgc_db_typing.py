...
class EInfo(CGCLocalDb):
    ...
    def _init_cgc_static_db_folder(self):
        ...
        if is_exist is False:
            ϵ_dict = {"σμν": 1, "σ~μ~ν": 1, "σ~μν~": 1, "σμ~ν~": 1,
                      "μσν": 1, "μ~σ~ν": 1, "μ~σν~": 1, "μσ~ν~": 1,
                      "νμσ": 1, "ν~μ~σ": 1, "ν~μσ~": 1, "νμ~σ~": 1,
                      "σνμ": 1, "σ~ν~μ": 1, "σ~νμ~": 1, "σν~μ~": 1,
                      "νσμ": 1, "ν~σ~μ": 1, "ν~σμ~": 1, "νσ~μ~": 1,
                      "μνσ": 1, "μ~ν~σ": 1, "μ~νσ~": 1, "μν~σ~": 1}
            ϵ_flags = {"σμν": (1, 1, 1), "σ~μ~ν": (1, 1, 1), "σ~μν~": (1, 1, 1), "σμ~ν~": (1, 1, 1),
                       "μσν": (1, 1, 1), "μ~σ~ν": (1, 1, 1), "μ~σν~": (1, 1, 1), "μσ~ν~": (1, 1, 1),
                       "νμσ": (1, 1, 1), "ν~μ~σ": (1, 1, 1), "ν~μσ~": (1, 1, 1), "νμ~σ~": (1, 1, 1),
                       "σνμ": (1, 1, 1), "σ~ν~μ": (1, 1, 1), "σ~νμ~": (1, 1, 1), "σν~μ~": (1, 1, 1),
                       "νσμ": (1, 1, 1), "ν~σ~μ": (1, 1, 1), "ν~σμ~": (1, 1, 1), "νσ~μ~": (1, 1, 1),
                       "μνσ": (1, 1, 1), "μ~ν~σ": (1, 1, 1), "μ~νσ~": (1, 1, 1), "μν~σ~": (1, 1, 1)}
